...
mixin _$HomeController on HomeControllerBase, Store {
  ...
  final _$drawerControllerAtom =
      Atom(name: 'HomeControllerBase.drawerController');

  @override
  ZoomDrawerController get drawerController {
    _$drawerControllerAtom.reportRead();
    return super.drawerController;
  }

  @override
  set drawerController(ZoomDrawerController value) {
    _$drawerControllerAtom.reportWrite(value, super.drawerController, () {
      super.drawerController = value;
    });
  }

  final _$slidableControllerAtom =
      Atom(name: 'HomeControllerBase.slidableController');

  @override
  SlidableController get slidableController {
    _$slidableControllerAtom.reportRead();
    return super.slidableController;
  }

  @override
  set slidableController(SlidableController value) {
    _$slidableControllerAtom.reportWrite(value, super.slidableController, () {
      super.slidableController = value;
    });
  }

  final _$massInsertAsyncAction = AsyncAction('HomeControllerBase.massInsert');

  @override
  Future massInsert() {
    return _$massInsertAsyncAction.run(() => super.massInsert());
  }
