...
mixin _$AddMovieController on _AddMovieControllerBase, Store {
  ...
  String get validType =>
      (_$validTypeComputed ??= Computed<String>(() => super.validType,
          ...
          .value;
  Computed<String>? _$validGenreComputed;

  @override
  String get validGenre =>
      (_$validGenreComputed ??= Computed<String>(() => super.validGenre,
              name: '_AddMovieControllerBase.validGenre'))
          .value;
  ...
  final _$genreAtom = Atom(name: '_AddMovieControllerBase.genre');
  ...
  @override
  dynamic setGenre(String v) {
    final _$actionInfo = _$_AddMovieControllerBaseActionController.startAction(
        name: '_AddMovieControllerBase.setGenre');
    try {
